...
var WPmangaStreamPlugin = /** @class */ (function () {
    ...
    WPmangaStreamPlugin.prototype.parseNovelAndChapters = function (url) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var body, loadedCheerio, novel, summary, i, p, totalChapters, chapters;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        totalChapters = loadedCheerio(".eplister li").length;
                        chapters = loadedCheerio(".eplister li")
                            ...
                            return ({
                                ...
                                chapterNumber: ((_a = _this.options) === null || _a === void 0 ? void 0 : _a.reverseChapters)
