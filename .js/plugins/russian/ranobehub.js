                ...
                switch (_q.label) {
                    case 0:
                        ...
                        url += showLatestNovels
                            ? "last_chapter_at"
                            : ((_b = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _b === void 0 ? void 0 : _b.value) || "computed_rating";
                        url += "&status=" + (((_c = filters === null || filters === void 0 ? void 0 : filters.status) === null || _c === void 0 ? void 0 : _c.value) ? (_d = filters === null || filters === void 0 ? void 0 : filters.status) === null || _d === void 0 ? void 0 : _d.value : "0");
                        if (filters) {
                            if ((_f = (_e = filters.country) === null || _e === void 0 ? void 0 : _e.value) === null || _f === void 0 ? void 0 : _f.length) {
                                url += "&country=" + filters.country.value.join(",");
                            }
                            includeTags = [
                                (_h = (_g = filters.tags) === null || _g === void 0 ? void 0 : _g.value) === null || _h === void 0 ? void 0 : _h.include,
                                (_k = (_j = filters.events) === null || _j === void 0 ? void 0 : _j.value) === null || _k === void 0 ? void 0 : _k.include,
                            ].flat().filter(function (t) { return t; });
                            if (includeTags.length) {
                                url += "&tags:positive=" + includeTags.join(",");
                            }
                            excludeTags = [
                                (_m = (_l = filters.tags) === null || _l === void 0 ? void 0 : _l.value) === null || _m === void 0 ? void 0 : _m.exclude,
                                (_p = (_o = filters.events) === null || _o === void 0 ? void 0 : _o.value) === null || _p === void 0 ? void 0 : _p.exclude,
                            ].flat().filter(function (t) { return t; });
