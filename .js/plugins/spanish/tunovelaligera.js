...
var TuNovelaLigera = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        link = this.site;
                        link += ((_b = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _b === void 0 ? void 0 : _b.value) ? "/genero" + filters.genres.value : "/novelas";
                        link += "/page/".concat(pageNo, "?m_orderby=");
                        link += (showLatestNovels ? "latest" : ((_c = filters === null || filters === void 0 ? void 0 : filters.order) === null || _c === void 0 ? void 0 : _c.value) || "rating");
    ...
    TuNovelaLigera.prototype.parseNovelAndChapters = function (novelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var result, body, loadedCheerio, novel, novelCover, chapter, delay, lastPage, getChapters, getPageChapters, _a, _b;
            var _this = this;
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        chapterCheerio("#lcp_instance_0 li").each(function (i, el) {
                                                            var chapterName = chapterCheerio(el)
                                                                .find("a")
                                                                .text()
                                                                .replace(/[\t\n]/g, "")
                                                                .trim();
                                                            var releaseDate = chapterCheerio(el).find("span").text().trim();
