...
var HakoPlugin = /** @class */ (function () {
    ...
    HakoPlugin.prototype.parseNovels = function (loadedCheerio) {
        ...
        loadedCheerio("#mainpart .row .thumb-item-flow").each(function (index, ele) {
            ...
            if (url) {
                ...
                var novel = { name: name_1, path: url.replace(_this.site, ''), cover: cover };
                novels.push(novel);
            }
        });
        return novels;
    ...
    HakoPlugin.prototype.parseNovelAndChapters = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(this.site + novelPath)];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, result.text()];
                    case 2:
