...
for (const language of Object.keys(languages)) {
  const plugins = String(pluginsPerLanguage[language] || 0).padStart(3, '0');
  console.warn(
    `| ${language} | ${plugins} (${pluginsWithFiltersPerLanguage[language]}) |`,
  );
}
console.warn('|----------|------------------------|');
console.warn(
  `| Total | ${String(totalPlugins).padStart(3, '0')} (${String(totalPluginsWithFilter).padStart(3, '0')}) |`,
);
